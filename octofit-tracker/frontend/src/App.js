    ...
    <div className="App bg-light min-vh-100">
      ...
      <div className="container py-4">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center"><h1 className="display-4 mb-4">Bienvenido a Octofit Tracker</h1><p className="lead">Tu plataforma para registrar actividades, equipos, usuarios y entrenamientos.</p></div>} />
        </Routes>
      </div>
    </div>
  );
